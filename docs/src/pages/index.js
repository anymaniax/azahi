...
const Home = ({ sponsors }) => {
  return (
    <>
      <Seo
        title="Azahi"
        description="Hooks for fetching, caching and updating asynchronous data in Angular"
      />
      <Head>
        <title>
          Azahi - Hooks for fetching, caching and updating asynchronous data in
          Angular
        </title>
      </Head>
              ...
              <div className="col-span-12 lg:col-span-6 ">
                <div className="text-center lg:text-left md:max-w-2xl md:mx-auto ">
                  <h1 className="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:leading-none sm:text-6xl lg:text-5xl xl:text-6xl">
                    ...
                    <span>synchronization for Angular</span>
                  </h1>
                  <p className="mt-3 text-base text-gray-700 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                    Fetch, cache and update data in your Angular applications
                    all without touching any "global state".
                  </p>
              ...
              <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                <div>
                  <div>
                    ...
                    <p className="mt-2 lg:mt-4 text-base xl:text-lg lg:leading-normal leading-6 text-gray-600">
                      ...
                      Azahi where to get your data and how fresh you need it to
                      be and the rest is automatic. Azahi handles caching,
                ...
                <div className="mt-10 lg:mt-0">
                  <div>
                    ...
                    <p className="mt-2  lg:mt-4 text-base xl:text-lg lg:leading-normal leading-6 text-gray-600">
                      Azahi is configurable down to each observer instance of a
                      query with knobs and options to fit every use-case. It
                      comes wired up with infinite-loading APIs, and first class
        ...
        <div className="bg-gray-100 relative py-24 border-t border-gray-200 ">
          <div className="px-4 sm:px-6 lg:px-8  mx-auto container max-w-3xl sm:text-center">
            ...
            <p className="my-4 text-xl leading-7  text-gray-600">
              ...
              much code you're deleting when you use Azahi.
            </p>
          </div>
          <div
            style={{
          ...
          <div className="py-24 px-4 sm:px-6 lg:px-8  mx-auto container">
            <div className=" sm:text-center pb-16">
              ...
              <p className="mt-4 text-xl max-w-3xl mx-auto leading-7 text-gray-300">
                With Angular as the only dependency, Azahi is extremely lean,
                ...
                Walmart!), Azahi is jam packed with battle-hardened tools to
                help you succeed.
              </p>
            </div>
            <div>
